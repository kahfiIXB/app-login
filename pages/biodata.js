...
export default function BiodataPage() {
    ...
    fetch("/api/me")
      ...
      .then((data) => {
        ...
        if (data.user.biodataCompleted) {
          ...
          // Kalau belum punya biodata,
          // tetap isi full_name kalau sudah ada.
          setForm((prev) => ({
            ...prev,
            full_name: data.user.full_name || "",
          }));
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.message || "Gagal menyimpan biodata.");
      }
